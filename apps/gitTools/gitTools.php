...
$sdmassembler->incorporateAppOutput($sdmassembler_dataObject, $output, array('incmethod' => 'prepend'));

$sdmassembler->incorporateAppOutput($sdmassembler_dataObject, '<h3>Git Tools</h3><p>This app provides tools for working with git. At the moment the only tool is a <i>branch viewer</i> that show the current git branch at the top of the main_content menu wrapper on every page.</p><p>Further development of this app will occur in the future, and this app will have a variety of tools for using git with your SDM CMS site.</p>', array('incpages' => array('gitTools'), 'incmethod' => 'append'));
?>
