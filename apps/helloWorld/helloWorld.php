...
$sdmassembler_dataObject->content->$sdmassembler_requestedpage->main_content = '<h1>Prepended Hello World</h1>' . $sdmassembler_dataObject->content->$sdmassembler_requestedpage->main_content;
