...
//            var_dump($mediaToEditProperties, $mediaToEditsHtml, $mediaToEditProperties['sdmMediaDisplayName']);
            ...
            $editPanelFormElements = array(
                ...
                $sdmMediaDisplaysAdminForm->sdmFormCreateFormElement('sdmMediaType', 'select', 'Select the media\'s type.', $sdmMediaDisplaysAdminForm->sdmFormSetDefaultInputValues(array('Image' => 'image', 'Audio' => 'audio', 'Video' => 'video', 'Youtube Video' => 'youtube', 'HTML5 Canvas Image/Animation (Javascript file for HTML5 canvas tag)' => 'canvas',), $mediaToEditProperties['sdmMediaSourceUrl']), 7),
            );
            break;
        case 'addMedia':
            $editPanelFormElements = array(
                $sdmMediaDisplaysAdminForm->sdmFormCreateFormElement('sdmMediaDisplayName', 'text', 'Name or title for the media.', '', 1),
                ...
                $sdmMediaDisplaysAdminForm->sdmFormCreateFormElement('sdmMediaPlace', 'select', 'Position in display relative to other media.', $sdmMediaDisplaysAdminForm->sdmFormSetDefaultInputValues(range(1, 1000), 1), 3),
                ...
                // the following form elements are set internally at the moments as the functionality the represent has not yet been implemented.
