    ...
    switch ($adminMode) {
        case 'editMedia':
            ...
            $editPanelFormElements = array(
                ...
                $sdmMediaDisplaysAdminForm->sdmFormCreateFormElement('sdmMediaPlace', 'select', 'Media\'s palce. Represents media\'s position in display relative to other media in the same category.', $sdmMediaDisplaysAdminForm->sdmFormSetDefaultInputValues(array_combine(range(1, 1000), range(1, 1000)), $mediaToEditProperties['sdmMediaPlace']), 3),
                ...
                $sdmMediaDisplaysAdminForm->sdmFormCreateFormElement('sdmMediaType', 'select', 'Select the media\'s type.', $sdmMediaDisplaysAdminForm->sdmFormSetDefaultInputValues(array('Image' => 'image', 'Audio' => 'audio', 'Video' => 'video', 'Embed Media (External media from site like YouTube or Vimeo)' => 'youtube', 'HTML5 Canvas Image/Animation (Javascript file for HTML5 canvas tag)' => 'canvas',), $mediaToEditProperties['sdmMediaType']), 7),
                // hidden elements
