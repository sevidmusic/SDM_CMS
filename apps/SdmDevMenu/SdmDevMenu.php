...
// Possibly incorporate the following few lines that put together a list of available apps and pages into one array into the sdmCoreListAvailablePages() method
