 ...
 */
$sdmassembler->incorporateAppOutput($sdmassembler_dataObject, '<h2>jQuery Play</h2><p>This app demonstrates how jquery can be used with the SDM CMS. It will also let you know if jQuery and jQuery UI are working whenever you visit the homepage.</p>', array('wrapper' => 'main_content', 'incmethod' => 'append', 'incpages' => array('jqueryPlay')));
...
$output .= '<script type="text/javascript">' . trim(file_get_contents($sdmcore->getUserAppDirectoryPath() . '/jqueryPlay/jqueryPlay.js')) . '</script>';
