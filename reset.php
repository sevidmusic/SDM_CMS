<!-- Run this file to configure a new SDM CMS site. -->
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <div id="container">
            ...
            // initilize a SdmCore() object for reset.php to use
            $sdmcore = new SdmCore();
            ...
            echo '<p>An empty error log was created to track site errors. You can view the error log <a href="' . $sdmcore->sdmCoreGetRootDirectoryUrl() . '/index.php?page=SdmErrorLog">HERE</a></p>';
            ?>
        </div>
    </body>
</html>